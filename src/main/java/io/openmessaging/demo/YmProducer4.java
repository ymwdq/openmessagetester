 ...
 */
public class YmProducer4 implements Producer{
    private YmMessageFactory messageFactory = new YmMessageFactory();
    private YmBucketCache4 cache;
    private KeyValue properties;
    private String topicOrQueue;

    public YmProducer4(KeyValue properties) {
        this.properties = properties;
        // get the BucketCache
        this.cache = YmMessageRegister.getInstance().getCache();
    }
...
//        }
        cache.addMessage((YmMessageMeta)message, topicOrQueue);
    }
