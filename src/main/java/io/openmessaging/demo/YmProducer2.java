 ...
 */
public class YmProducer2 implements Producer{
    private YmMessageFactory messageFactory = new YmMessageFactory();
    private YmBucketCache3 cache;
    private KeyValue properties;

    public YmProducer2(KeyValue properties) {
        this.properties = properties;
        // get the BucketCache
        this.cache = YmMessageCollector2.getInstance().getCache();
    }
    ...
    public void send(Message message) {
        ...
        cache.addMessage((YmMessageMeta) message);
    }
